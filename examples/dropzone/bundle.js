(function() {
...
})()(
  {
        ...
        class FileReceiver extends EventEmitter2 {
          ...
          notImplemented(type) {
            if (this.throwOnNotImplemented) {
              throw new Error(
                `Processing '${type}' items is not yet implemented`
              );
            } else {
    ...
    6: [
      ...
      { "../../index": 8, "../browser/file-receiver": 5 }
    ],
    7: [
      function(require, module, exports) {
        ...
        class SchemaMiller {
          ...
          static async mill(payload, schemaLinks, remoteMill) {
            ...
            for (let i = 0; i < sorted.length; i += 1) {
              ...
              const resolved = SchemaMiller.resolveDependency(
                normal,
                payloadsByName
              );
      ...
      function(require, module, exports) {
        ...
        class Thread extends API {
          ...
          async add(name, options) {
            const added = await this.sendPost(
              "/api/v0/threads",
              [name],
              options
            );
    ...
    24: [
      ...
      },
      {
        "../cancel/isCancel": 20,
        "../defaults": 28,
        "./../helpers/combineURLs": 32,
        "./../helpers/isAbsoluteURL": 34,
        "./../utils": 39,
        "./transformData": 27
      }
    ],
